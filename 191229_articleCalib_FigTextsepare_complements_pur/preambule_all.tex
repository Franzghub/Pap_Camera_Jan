...
\ProvidesPackage{PreambuleScience}

%% Francisation
\usepackage[francais,english]{babel}	% Typographie ou frenchb ?
...
\usepackage{multicol}		% Plusieurs colonnes    \begin{multicols}{3}
...
\usepackage{fancyvrb}    %changer taill de verbatim %\begin{Verbatim}[fontsize=\small]
\usepackage{gensymb} %pour le ° 
...
\usepackage{rotating}.        %tourner figures
\usepackage{color,colortbl} % couleur et couleur tableaux
...
\usepackage{float, caption} % figures flottantes
\usepackage[usenames, dvipsnames]{xcolor} %à déclarer avant tikz ++
\usepackage{pgf, tikz}
\usepackage{subfig}
...
%%several files : https://www.sharelatex.com/learn/Multi-file_LaTeX_projects
\usepackage{subfiles}
